...
```{r, fig.cap='Map of Ontario study areas with example study area shown in red', fig.width=8, fig.height=8}
...
```{r, fig.cap = "Fig 5. Distribution of land cover by hexagon, sample, sample plus hexagon and study area", fig.width=12, fig.height=8}
...
## Analysis of Benefit Calculation
...
```{r, fig.cap="The number of draws a sample unit was selected out of 200 GRTS runs of 30 ARUs based on the benefit (left) and absolute difference from the study area (right)"}
