---
title: "N Ontario Study Areas _ Selected"
author: "David Hope"
date: "`r Sys.Date()`"
output:
...
highlight: github
vignette: >
  %\VignetteIndexEntry{N Ontario Study Areas - Selected}
...
From `StudyAreas.Rmd`. Just national land cover for now.
```{r}
...
From `OntCost_v1.2.Rmd`. Cost model with 30 ARUs per study area.
```{r}
...
```{r BASS-run, warning=F, message=F, eval=F}
