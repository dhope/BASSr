---
title: "Hexagon Creation"
author: "Russ Weeber, Rich Russell, Nora Spencer, others, David Hope"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Hexagon Creation}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---


I'm going to create a hexagon grid for Northern Ontario using 1km diameter spacing between centroids for sampling units and 25 km diameters for the study areas. I'll have to confirm this later. I'll also make unique identifiers for each hexagon and assign them to an ecoregion.
...
Lets create the large hexagons first
```{r}
...
Now do the same with smaller hexagons 
