...
## ----land-cover-hexes, fig.cap = "Fig 2. The cumulative proportion of land cover classes within sample hexagons (grey) and the study area (black)"----
hex_LC <- 
...
## ---- fig.cap = "Fig 4. Plot of focal hexagon (red) and random sample of hexagons (grey)"----
...
## ---- fig.cap = "Fig 5. Distribution of land cover by hexagon, sample, sample plus hexagon and study area"----
...
## ----all-benefits, fig.lab = "Fig 6. Benefit distribution across all hexagons in a study area"----
