...
#  
#  write_rds(fbr_study_area_test, "output/2020-01-14_studyarea_test_results.rds")
#  
...
## ---- message=F, warning=F----------------------------------------------------
fbr_study_area_test <- read_rds(here::here("output/2020-01-14_studyarea_test_results.rds"))
...
#                                        id_col = StudyAreaID, hab_rast_location = habLoc,
#                                        primary_roads = roadloc1, secondary_roads = roadloc2,
#                                        return_all_ = T, write_hexes = F, quick = T,
#                                        load_hexes = T, rds.loc = here::here("output")))
#    }
...
#  
#  write_rds(all_samples, "output/2020-01-15_allsamples_drawARUsInBASS.rds")
#  
#  

## ---- fig.width=12, fig.height=12---------------------------------------------
as2 <- read_rds(here::here( "output/2020-01-15_allsamples_drawARUsInBASS.rds"))
